...
const setWeatherData = data => {
    ...
    const weatherData = {
        ...
        temperatureUno: Math.round(data.hourly[3].temp),
        descriptionUno: data.hourly[3].weather[0].description,
        temperatureDos: Math.round(data.hourly[7].temp),
        descriptionDos: data.hourly[7].weather[0].description,
        temperatureTres: Math.round(data.hourly[11].temp),
        descriptionTres: data.hourly[11].weather[0].description,
        temperatureCuatro: Math.round(data.hourly[15].temp),
        descriptionCuatro: data.hourly[15].weather[0].description,
        temperatureCinco: Math.round(data.hourly[19].temp),
        descriptionCinco: data.hourly[19].weather[0].description,
        temperatureSeis: Math.round(data.hourly[23].temp),
        descriptionSeis: data.hourly[23].weather[0].description,
